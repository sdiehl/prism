...
// the committed fixtures, so a regression in Json/Bytes surfaces here.
const DIGEST: &str = "tiles=3 bytes=24 above=11 sum=2804";
const SUMMARY: &str = r#"{"threshold":128,"tiles":[{"above":3,"count":8,"histogram":[3,2,2,1],"name":"north","sum":744},{"above":4,"count":8,"histogram":[1,3,3,1],"name":"south","sum":1040},{"above":4,"count":8,"histogram":[4,0,0,4],"name":"delta","sum":1020}],"total":{"above":11,"count":24,"sum":2804}}"#;
...
// require it succeeded and produced the expected digest and canonical summary.
