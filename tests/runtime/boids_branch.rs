...
//! These check what makes the two side-by-side timelines honest: a branch is a
...
// Mirrors the sentinel in examples/boids.pr and src/wasm/mod.rs: the pure kernel the
