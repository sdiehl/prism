...
"#;
    ...
    // The drift surfaces as the structured frozen-shape diagnostic (E6026).
    assert_eq!(
        ty.code(),
        Some("E6026"),
        "expected the frozen-shape-changed diagnostic (E6026), got: {err}"
    );
