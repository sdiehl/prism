...
//
// This pins Base's surface as a committed golden so accidental growth fails
...
//
// Regenerate deliberately with: INSTA_UPDATE=always cargo test --test base_surface
