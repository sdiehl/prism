...
[^p-wholeprogram]: Whole-program compilation as the semantic baseline is MLton's ([Weeks, 2006](bibliography.md#weeks-2006)); the join of separately checked modules into one optimized program follows it deliberately, trading separate codegen for cross-module truth.
