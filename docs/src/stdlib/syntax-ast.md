...
```prism,def,h-943bf410454e6788eab6974fd261295aa8780b1821964aa1383486b68373a981
type Pat
  = PWild
  | PVar(String)
  | PInt(String, Suffix)
...
```prism,def,h-76a1e57aee97525454270aa621bdeca3f8a08f89d5a6b37f79737fccd1e7c5c5
type Param = Param {
  name: String,
  pat: Option(Sp(Pat)),
  ty: Option(Ty),
...
```prism,def,h-422230ddafb74958b5f4a75399492f0e2d461a8b17af5a6a05e9237aa7ea01ba
type Item
