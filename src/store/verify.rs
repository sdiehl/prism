...
//!
//! This is the logic over the raw record I/O
//! ([`Store::put_verified`](crate::store::disk::Store::put_verified) and
//! [`Store::verified`](crate::store::disk::Store::verified)): canonical
//! `check-kind` names in one place, and the
