...
pub use code::{
    ErrorCode, ErrorPhase, INCOMPLETE_HANDLER, PARSE_DEPTH, SMT_LOGIC_WELLFORMED,
    TYPED_CORE_CONSTRUCTION, TYPED_CORE_EFFECT_LOWERING, TYPED_CORE_ENVIRONMENT,
    TYPED_CORE_ERASURE, TYPED_CORE_SIMPLIFY, TYPED_CORE_SPECIALIZATION, TYPED_CORE_VERIFICATION,
    TYPED_HOLE,
};
