...
pub use super::node_id::minted_id;
...
impl LineageCache {
    ...
    #[must_use]
    pub const fn from_stats(stats: prism_store::disk::CommitStats) -> Self {
        Self {
            enabled: true,
...
impl LineageGraph {
    ...
    pub fn world_state_by_selector(&self, id: &str) -> Result<&Node, Error> {
