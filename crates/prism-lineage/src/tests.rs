...
use crate::diff::LogicalKey;
use crate::graph::{BuildRequest, CompilerPayload, CompilerRow, RequestKind};
...
const WORLD_FIXTURE: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../../tests/fixtures/world.plineage"
);
