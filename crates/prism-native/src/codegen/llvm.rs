...
pub fn scc_function_map(
    ...
    for members in prism_core::core::scc_groups(core) {
...
impl PlannedClosures {
    ...
    #[must_use]
    pub fn shards(&self) -> Vec<(ClosurePlanShard, String)> {
...
pub fn plan_closures_from_summaries(
    core: &LoweredCore,
    ctors: &BTreeMap<String, CtorInfo>,
...
pub fn emit_closure_plan_shard_bitcode(
    core: &LoweredCore,
    ctors: &BTreeMap<String, CtorInfo>,
