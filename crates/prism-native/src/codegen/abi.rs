...
pub(crate) const TAG_OFF: i64 = 8;
pub(crate) const HDR_BYTES: i64 = 24;
pub(crate) const WORD_BYTES: i64 = 8;

pub(crate) const STR_TAG: i64 = 0x5354_5200;
pub(crate) const BIG_TAG: i64 = 0x4249_4700;
